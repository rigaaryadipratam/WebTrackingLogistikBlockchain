...
<div class="page-header">
    ...
    <p class="text-muted">Update journey of products through the supply chain using blockchain verification</p>
</div>
                ...
                <div class="card-body">
                    <form method="POST" action="index.php?action=update_location">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <!-- Contoh tombol yang sesuai dengan kode di atas -->
    ...
    <div class="col-lg-8">
        <?php if (!empty($barcode)): ?>
            <?php if (!empty($productInfo)): ?>
                ...
                <div class="card shadow-sm">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span><i class="bi bi-geo-alt me-2"></i> Tracking History</span>
                        <div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <div class="mb-3">
                    ...
                    <div class="scanner-container bg-light p-3 rounded mb-3" style="height: 240px; display: flex; align-items: center; justify-content: center;">
                        <div class="d-flex flex-column align-items-center">
                            <i class="bi bi-upc-scan text-muted mb-3" style="font-size: 3rem;"></i>
                            <p class="text-muted">Camera access not available in prototype</p>
                        </div>
                    </div>
                    <div class="form-text">Note: Actual barcode scanning would require camera integration</div>
                </div>
                <div class="input-group mb-3">
                    <input type="text" class="form-control" id="manualBarcodeInput" placeholder="Or enter barcode manually">
                    <button class="btn btn-primary" type="button" id="submitBarcode">Submit</button>
                </div>
            </div>
        </div>
    </div>
